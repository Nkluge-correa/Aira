...
def main(spec_file):
    ...
    if data_args.dataset_name is not None:
        ...
        raise ValueError("No dataset provided. Try running with `dataset_name=nicholasKluge/toxic-aira-dataset`")
    ...
    if extra_args.wandb_token is not None: 
        ...
        wandb.init(
            ...
            notes="Fine tuning base model on the AIRA-toxicity dataset",
            tags=["Alignment", "reward-modeling", "toxicity-detection", "Aira"],
            config=all_kwargs
        )
...
# How to run:
# python toxicity-modeling.py --spec-file toxicity-modeling-specs.yaml
